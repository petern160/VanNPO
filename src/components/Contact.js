  ...
  return (
    <div className="LungCancer">
      ...
      <div className="LungCancerBody">
        ...
        <ul>
          <li>
            New, changing or worsening cough, especially if the sputum contains
            blood
          </li>
          <li>
            Change in the ability to perform exercise (e.g. shortness of breath
            with walking)
          </li>
        ...
        <p>
          Lung cancer screening using low-dose CT scans is currently recommended
